...
export const MOCK_DEALS: FlashDeal[] = [
  ...
  { id: 'd3', serviceName: 'Pool Cleaning', image: 'https://picsum.photos/seed/deal-pool/400/250', originalPrice: 89, dealPrice: 49, savingsPercent: 45, endsAt: hoursFromNow(8), totalQuantity: 15, claimed: 9, category: 'today', description: 'First month of Basic weekly pool service ($89/mo tier)' },
