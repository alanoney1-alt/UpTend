...
const pricingServices: ServicePricing[] = [
  {
    ...
    price: "$49 / $99",
    description: "Complete home documentation: Standard ($49) interior walkthrough or Aerial ($99) with drone footage. 100% reimbursed on your first service booking.",
    benefit: "Protects property value • Insurance-ready documentation • Free with first booking",
    icon: ClipboardCheck,
    featured: true,
  },
  {
  ...
  {
    id: "furniture_moving",
    name: "LiftCrew™ (Furniture Moving)",
    price: "From $99",
    description: "Professional furniture moving and staging within your home or property.",
    benefit: "Protects valuable furniture • Storm preparation ready",
    icon: Package,
  },
  {
    id: "moving_labor",
  ...
  {
    id: "truck_unloading",
    name: "UnloadPro™ (Truck Unloading)",
    price: "$80/hr",
    description: "Fast and efficient truck unloading with professional handling of your items.",
    benefit: "Quick turnaround • Prevents damage during moves",
    icon: Truck,
  },
  {
    id: "garage_cleanout",
