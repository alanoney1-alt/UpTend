...
const pricingServices: ServicePricing[] = [
  {
    ...
    price: "$49 / $149",
    description: "Complete home documentation: Standard ($49) interior walkthrough or Aerial ($149) with drone footage. 100% reimbursed on your first service booking.",
