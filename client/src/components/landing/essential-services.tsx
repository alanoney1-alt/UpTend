...
const services = [
  ...
  {
    icon: Stethoscope,
    title: "DwellScan™ (Home Audit)",
    shortTitle: "DwellScan™",
    tagline: "Know your home inside out.",
    spin: "Full interior walkthrough and personalized maintenance report. Upgrade to DwellScan Aerial for $149 and add a drone-powered roof and gutter scan.",
