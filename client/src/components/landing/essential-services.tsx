...
const services = [
  ...
  {
    icon: Stethoscope,
    title: "30-min Home Health Audit",
    shortTitle: "Home Health Check",
    tagline: "Get a Home Score. Know your property.",
    spin: "A certified Asset Manager audits 10 zones in your home and builds a treatment plan.",
    price: "$49.00",
