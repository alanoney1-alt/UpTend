...
const services = [
  ...
  },
  {
    icon: Stethoscope,
    title: "AI Home Audit",
    shortTitle: "AI Home Audit",
    tagline: "Know your home inside out.",
    spin: "Full interior walkthrough and personalized maintenance report. Upgrade to AI Home Audit Aerial for $149 and add a drone-powered roof and gutter scan.",
