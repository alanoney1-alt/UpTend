        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3 text-sm hover:text-white transition-colors">
                ...
                <a href="mailto:george@uptendapp.com" data-testid="text-footer-email">george@uptendapp.com</a>
              </div>
              <div className="flex items-center gap-3 text-sm hover:text-white transition-colors">
          ...
          <div>
            ...
            <div className="flex gap-4 mb-4">
              <a href="https://facebook.com/profile.php?id=61588411529957" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-white transition-colors" aria-label="Facebook">
              ...
              <a href="https://x.com/uptendgeorge" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-white transition-colors" aria-label="X / Twitter">
