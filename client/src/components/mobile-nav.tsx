...
import { Home, ClipboardList, User, AlertCircle } from "lucide-react";
...
const customerNavItems: NavItem[] = [
  ...
  { path: "/book", label: "Book", icon: ClipboardList },
  { path: "/profile", label: "Profile", icon: User },
];

const pyckerNavItems: NavItem[] = [
  { path: "/", label: "Home", icon: Home },
  { path: "/pro/dashboard", label: "Dashboard", icon: ClipboardList },
  { path: "/profile", label: "Profile", icon: User },
];
