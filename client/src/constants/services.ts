export const SERVICES = {
  ...
  carpet_cleaning: {
    ...
    minimumCharge: 99,
    tiers: {
      standard: { name: 'Standard Steam Clean', price: 39, unit: 'per room', description: 'Steam/hot water extraction, pre-treatment, vacuum' },
      deep_clean: { name: 'Deep Clean', price: 59, unit: 'per room', description: 'Standard + enzyme treatment, heavy soil agitation, slow dry pass' },
      pet_treatment: { name: 'Pet Treatment', price: 69, unit: 'per room', description: 'Deep clean + pet odor enzyme + sanitizer' },
      ...
      package_3br: { name: '3BR/2BA Standard Package', price: 149, unit: 'flat', description: 'All rooms + hallway' },
      package_4_5br: { name: '4-5BR Standard Package', price: 199, unit: 'flat', description: 'All rooms + hallways' },
    },
  },
  landscaping: {
    branded: 'Landscaping',
  ...
  gutter_cleaning: {
    ...
    tiers: {
      ...
      '1_story_large': { name: '1-Story Large (150-250 linear ft)', price: 169 },
      '2_story': { name: '2-Story (up to 150 linear ft)', price: 199 },
      '2_story_large': { name: '2-Story Large (150-250 linear ft)', price: 249 },
      '3_story': { name: '3-Story', price: 299 },
    },
    addOns: {
  ...
  pool_cleaning: {
    ...
    tiers: {
      basic: { name: 'Basic', price: 89, unit: 'mo', description: 'Weekly chemicals + skim surface + empty baskets' },
      standard: { name: 'Standard', price: 129, unit: 'mo', description: 'Basic + brush walls + vacuum + filter check' },
      full_service: { name: 'Full Service', price: 169, unit: 'mo', description: 'Standard + tile cleaning + equipment monitoring + filter cleaning' },
      deep_clean: { name: 'One-Time Deep Clean', price: 199, unit: 'one-time', description: 'Deep clean for neglected/green pools' },
    },
  },
  light_demolition: {
