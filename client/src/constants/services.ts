export const SERVICES = {
  ...
  moving_labor: {
    ...
    subTypes: {
      furniture_moving: { name: 'Furniture Moving', price: 65, unit: 'per hour per Pro', description: 'In-home or local furniture moving with blankets & straps' },
      truck_unloading: { name: 'Truck/Pod Unloading', price: 65, unit: 'per hour per Pro', description: 'Unload your rental truck, pod, or trailer' },
      general_labor: { name: 'General Labor', price: 65, unit: 'per hour per Pro', description: 'Loading, unloading, rearranging — flexible muscle on demand' },
    },
  },
  home_cleaning: {
  ...
  gutter_cleaning: {
    ...
    tiers: {
      '1_story': { name: '1-Story (up to 150 linear ft)', price: 150 },
      '1_story_large': { name: '1-Story Large (150-250 linear ft)', price: 195 },
      '2_story': { name: '2-Story (up to 150 linear ft)', price: 225 },
      '2_story_large': { name: '2-Story Large (150-250 linear ft)', price: 285 },
  ...
  pool_cleaning: {
    ...
    tiers: {
      basic: { name: 'Basic', price: 120, unit: 'mo', description: 'Weekly chemicals + skim surface + empty baskets' },
