          ...
          <div className="flex flex-col md:flex-row gap-12 items-start" data-testid="section-pillar-protect">
            ...
            <div className="text-left">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Your home is probably your biggest investment. You should have proof of everything that's ever been done to it. That's why we built the <strong className="text-foreground">360\u00B0 Video Documentation</strong> and the <strong className="text-foreground">Home Audit</strong>—to give you an actual record. Not for us. For you. For your insurance company. For your next landlord or mortgage broker. Every job gets documented, timestamped, and verified. You never have to say "trust me" again. You have proof.
              </p>
            </div>
          </div>
