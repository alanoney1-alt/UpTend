...
const services = [
  ...
  // 3. Junk Removal
  {
    ...
    includes: [
      "Minimum load: $99",
      "1/8 truck: $179 | 1/4 truck: $279",
      "1/2 truck: $379 | 3/4 truck: $449",
      "Full truck: $549",
  ...
  // 8. Landscaping
  {
    ...
    includes: [
      ...
      "Mow & Go: $99/mo (≤¼ acre) | $149/mo (≤½ acre)",
      "Full Service: $159/mo (≤¼ acre) | $219/mo (≤½ acre)",
      "Premium: $249/mo (≤¼ acre) | $329/mo (≤½ acre)",
