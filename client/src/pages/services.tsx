...
const services = [
  // === FEATURED SERVICE ===
  {
    ...
    description: "A 30-minute on-site intelligence scan by a verified Level 3 Consultant. Smart inventory, 360° video documentation, and a treatment plan with transparent pricing. Choose Standard ($99) or Aerial with drone scan ($199). $49 back on your next booking.",
    price: "From $99",
