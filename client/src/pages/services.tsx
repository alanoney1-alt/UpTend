...
const services = [
  ...
  // 3. Junk Removal
  {
    ...
    price: "From $99",
    includes: ["Full property walkthrough", "Verified Impact Report", "Circular economy sorting", "ESG compliance documentation"],
  ...
  // 5. Moving Labor
  {
    ...
    includes: ["Furniture Moving — $65/hr per mover", "Truck/Pod Unloading — $65/hr per mover", "General Labor — $65/hr per mover", "Dollies, hand trucks & shrink wrap included"],
  ...
  // 7. Carpet Cleaning
  {
    ...
    description: "Standard Steam Clean $50/room, Deep Clean $75/room, Pet Treatment $89/room. Whole house packages: 3BR/2BA $129, 4-5BR $215. $100 minimum charge.",
    price: "From $50/room",
            ...
            >
              <CardContent className="p-5 md:p-8 bg-gradient-to-br from-primary/10 to-primary/5">
                ...
                <p className="text-foreground text-base leading-relaxed mb-4" data-testid={`text-service-desc-${svc.id}`}>
                  {t(`svc.${svc.id}_desc`, svc.description)}
                </p>
