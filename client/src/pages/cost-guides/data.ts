...
export const costGuides: CostGuide[] = [
  ...
  },
  {
    ...
    metaDescription: "Carpet cleaning in Orlando costs $39–$69 per room. See full tier pricing and book with UpTend.",
    ...
    factors: [
      ...
      "Cleaning tier — Standard ($39/room), Deep Clean ($59/room), or Pet Treatment ($69/room)",
    ...
    tips: [
      ...
      "Choose Pet Treatment ($69/room) if you have pets — standard cleaning won't fully eliminate odors",
      "Whole house packages (3BR $149, 4-5BR $199) save vs. per-room pricing",
    ],
    description: "UpTend Carpet Cleaning: Standard Steam Clean $39/room, Deep Clean $59/room, Pet Treatment $69/room. Hallways $25 each, stairs $25/flight. Scotchgard protectant $20/room add-on. Whole house packages: 3BR/2BA $149, 4-5BR $199. $99 minimum charge (covers up to 2 rooms standard).",
  },
];
