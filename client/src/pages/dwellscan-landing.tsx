    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-20 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold mb-4">Choose Your DwellScan™</h2>
            ...
            <Card className="border-2">
              <CardContent className="pt-6">
                <div className="text-center mb-6">
                  ...
                  <h3 className="text-2xl font-bold mb-2">DwellScan™ Standard</h3>
            ...
            <div className="flex items-start gap-4 max-w-3xl mx-auto">
              ...
              <div>
                ...
                <p className="text-green-800 dark:text-green-200">
                  ...
                  DwellScan Standard is essentially <strong>free</strong> when you book a
                  follow-up service, and Aerial is effectively just $100 for a drone inspection
                  worth $290+.
                </p>
              </div>
            </div>
      ...
      <section className="py-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-muted-foreground mb-8">
            DwellScan™ helps homeowners protect their biggest investment with verified,
            documented maintenance insights. Whether you're buying, selling, renting, or just
            want to know what your home needs, DwellScan gives you the clarity you deserve.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 px-6 bg-primary text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl mb-8 opacity-90">
            Book your DwellScan™ today. Most homes can be scanned within 48 hours.
          </p>
          <div className="flex gap-4 justify-center flex-wrap">
            <Button
              size="lg"
      ...
      <section className="py-16 px-6 bg-muted/30">
        <div className="max-w-4xl mx-auto prose prose-sm dark:prose-invert">
          <h2>DwellScan™ Home Audit Service in Orlando, Florida</h2>
          <p>
            DwellScan is UpTend's comprehensive home inspection and audit service designed
            specifically for Central Florida homeowners. Unlike traditional home inspections that
            focus solely on pre-purchase assessments, DwellScan provides ongoing home health
            monitoring for existing homeowners, renters, landlords, and property managers.
          </p>

          <h3>What is included in a DwellScan Standard?</h3>
          <p>
            DwellScan Standard ($49) includes a complete interior and exterior ground-level
          ...
          <h3>What makes DwellScan Aerial different?</h3>
          <p>
            DwellScan Aerial ($149) adds a FAA Part 107 certified drone flyover to capture aerial
          ...
          <p>
            Yes! Every DwellScan (Standard or Aerial) includes a $49 credit toward any UpTend
            service booked within 90 days. This means DwellScan Standard is essentially free when
            you book a follow-up service like junk removal, home cleaning, or pressure washing.
          </p>

          <h3>Who performs the inspection?</h3>
          <p>
            All DwellScan Standard inspections are performed by UpTend's verified Pros who are
            background-checked and insured. DwellScan Aerial inspections are performed by FAA Part
          ...
          <h3>How is DwellScan different from a traditional home inspection?</h3>
          <p>
            Traditional home inspections ($300-$500) are designed for pre-purchase due diligence
            and focus on major structural and system defects. DwellScan is designed for ongoing
