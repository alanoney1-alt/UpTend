            ...
            <div className="space-y-6">
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="space-y-1.5">
                    <Label htmlFor="notes">What's going on? <span className="text-muted-foreground font-normal">(optional)</span></Label>
                    <Input
                      id="notes"
                      placeholder="Not cooling, strange noise, unit is old…"
                      value={form.notes}
