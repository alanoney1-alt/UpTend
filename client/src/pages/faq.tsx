...
const faqs: FAQ[] = [
  ...
  },
  {
    ...
    answer: "Yes! Bundling services often saves you money. For example, book DwellScan™ + Gutter Cleaning + Pressure Washing together and receive 10-20% off the total. Our smart booking system will suggest relevant bundle deals based on your property and season."
  },
  {
    category: "customers",
  ...
  },
  {
    ...
    answer: "Times vary by service: Junk removal (1-3 hours), Home Cleaning (2-4 hours), Landscaping (1-2 hours), Pressure Washing (2-5 hours), Gutter Cleaning (1-2 hours), Pool Cleaning (45-90 min), Carpet Cleaning (2-4 hours), DwellScan™ Standard (45-90 min), DwellScan™ Aerial (90-120 min). Your Pro provides an estimated completion time upon arrival."
  },
  {
    category: "customers",
  ...
  },
  {
    ...
    answer: "Yes! Pros document all work with timestamped before/after photos uploaded to your job record. This provides proof of completion, quality verification, and a visual record for your files. Photos are especially valuable for DwellScan™, pressure washing, and junk removal services."
  },
  {
    category: "customers",
  ...
  },
  {
    ...
    answer: "We specialize in turnover! Services include: junk removal of abandoned items, deep cleaning, carpet cleaning, minor repairs, yard restoration, and DwellScan™ documentation. Book as a bundle for 20% off. Average turnover time: 1-3 days depending on property condition. Perfect for property managers with tight timelines."
  },
  {
    category: "b2b",
  ...
  {
    category: "pricing",
    question: "What is your pricing for DwellScan™?",
    answer: "DwellScan™ Standard (interior only) is $49 flat rate. DwellScan™ Aerial (interior + drone exterior) is $99 flat rate. Both include comprehensive photo documentation, detailed inspection notes, and digital report delivery within 24 hours. Add-ons available: rush delivery (3-hour report) +$25, extra property photos +$20."
  },
  {
    category: "pricing",
