...
## 2. AI Analysis Disclaimer

UpTend uses artificial intelligence ("AI") to analyze photographs and estimate the age, condition, and remaining useful life of home systems and appliances.

- AI analysis is **assistive and not definitive**. All estimates are approximate.
- UpTend makes **no guarantees** regarding the accuracy, completeness, or reliability of AI-generated assessments, including but not limited to age estimates, condition ratings, maintenance recommendations, or remaining lifespan projections.
- AI analysis is limited to what is visible in submitted photographs and cannot detect hidden defects, structural issues, code violations, environmental hazards, or conditions not visible in images.

## 3. Customer Responsibility for Photo Accuracy

Customer is solely responsible for:
- The accuracy, quality, and completeness of all photographs submitted.
- Ensuring photographs accurately represent the current state of the property, systems, and appliances.
- Providing photographs of all relevant areas and systems for a comprehensive scan.

UpTend's analysis is only as good as the photos provided. Incomplete, blurry, misleading, or outdated photographs may result in inaccurate analysis. UpTend bears no responsibility for analysis errors caused by inadequate photo submissions.
...
- UpTend may cancel, suspend, or modify the rewards program at any time. Earned credits will be honored through their expiration date.
- Credits cannot be combined with other promotions unless explicitly stated.
...
- Aggregated, anonymized analytics to improve UpTend's platform and services.

Customer's data will **never be sold** to third parties. Service provider matching shares only the minimum information necessary to provide a quote or service.
...
## 8. Photo Content & Property Ownership

Customer represents and warrants that:
- Customer owns the property depicted in submitted photographs **or** has obtained express permission from the property owner to submit such photographs.
- Submitted photographs do not violate the privacy rights of any third party.
- Photographs do not contain images of individuals without their consent, illegal activity, or content unrelated to the home scan.
- Customer has the legal right to authorize AI analysis of the depicted property.

UpTend reserves the right to reject or remove photographs that violate these requirements.
...
For Customers who purchase the Drone Scan add-on:
- UpTend engages **FAA Part 107-certified drone operators** as independent contractors to perform aerial photography of the property.
- Customer acknowledges that drone operations are subject to Federal Aviation Administration (FAA) regulations, local ordinances, and airspace restrictions.
- UpTend is **not liable for delays or cancellations** due to weather conditions, airspace restrictions, FAA temporary flight restrictions (TFRs), or other factors outside UpTend's reasonable control.
- Customer is responsible for ensuring legal access to the property and notifying UpTend of any HOA or local restrictions on drone use.
- Drone operators carry their own liability insurance. UpTend is not responsible for damage caused by drone operators during the scan.

## 11. Pro Scan Add-On ($99)

For Customers who purchase the Pro Scan add-on:
- UpTend connects Customer with a qualified service professional ("Pro") to perform an in-person scan of the property.
- The Pro is an **independent contractor**, not an employee of UpTend.
- Standard UpTend service terms apply to the Pro Scan, including UpTend's Terms of Service.
- UpTend is not responsible for the Pro's acts, omissions, opinions, or assessments beyond the scope of UpTend's standard service guarantee.
...
Communications may be sent via SMS, email, push notification, or in-app messaging. Customer may opt out of non-essential communications at any time through account settings. Opting out of transactional notifications (e.g., scan status) is not available while a scan is in progress.
