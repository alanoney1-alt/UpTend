 ...
 */
router.post("/:jobId/verify-price", async (req, res) => {
  try {
...
/**
 * GET /api/jobs/:jobId/verification
 * Get current verification status for a job
 */
router.get("/:jobId/verification", async (req, res) => {
  try {
    const { jobId } = req.params;
...
/**
 * POST /api/jobs/:jobId/verification/:verificationId/approve
 * Customer approves price adjustment
 */
router.post("/:jobId/verification/:verificationId/approve", async (req, res) => {
  try {
...
/**
 * POST /api/jobs/:jobId/verification/:verificationId/decline
 * Customer declines price adjustment
 */
router.post("/:jobId/verification/:verificationId/decline", async (req, res) => {
  try {
    const { verificationId } = req.params;
...
/**
 * POST /api/jobs/:jobId/verification/:verificationId/timeout
 * Handle approval timeout (called by scheduled job after 30 minutes)
 */
router.post("/:jobId/verification/:verificationId/timeout", async (req, res) => {
  try {
    const { verificationId } = req.params;
