...
export function registerProStatusRoutes(app: Express) {
  ...
  app.get("/api/pros/nearby", async (req, res) => {
    try {
...
export const registerHaulerStatusRoutes = registerProStatusRoutes;
