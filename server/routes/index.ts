...
import { registerViolationDetectionRoutes } from "./hoa/violation-detection.routes";
...
import { registerPublicLeadRoutes } from "./public-leads.routes";
...
export async function registerRoutes(
  ...
  registerViolationDetectionRoutes(app);
  ...
  // Register Partner Operations 3 routes (QuickBooks, Calendar, Timesheets)
