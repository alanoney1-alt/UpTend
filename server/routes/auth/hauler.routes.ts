...
// Hauler/PYCKER registration schema
...
/**
 * Hauler Authentication Routes
 * Handles PYCKER (hauler) registration, login, logout, and email verification
 */
export async function registerHaulerAuthRoutes(app: Express): Promise<void> {
  // Legacy hauler check-username endpoint
  ...
  app.post("/api/haulers/login", async (req, res, next) => {
    passport.authenticate("local", async (err: any, user: any, info: any) => {
      if (err) {
        console.error("Hauler login error:", err);
