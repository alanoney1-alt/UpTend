...
export async function searchProduct(
  ...
  return {
    results: allResults,
    ...(dangerFlag ? {
      dangerWarning: `⚠️ "${dangerFlag}" is flagged as dangerous DIY. I found products, but honestly? This one's dangerous to DIY. Let me get you a pro quote — it's worth the safety.`,
    } : {}),
  };
}
  ...
  if (matchedAppliance) {
    ...
    return {
      ...
      dangerWarning: dangerFlag
        ? `⚠️ This involves ${dangerFlag} — dangerous to DIY. Let me get you a pro quote instead.`
