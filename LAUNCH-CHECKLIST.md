...
| # | Issue | Source | Status |
|---|-------|--------|--------|
| 23 | **12+ George tools return hardcoded mock data** (HOA scheduling, community health, board reports, etc.) | Round 8 | ❌ Open |
...
| 38 | **george-agent.ts has 5300+ lines** — tool definitions should be extracted | Round 8 | ❌ Open |
