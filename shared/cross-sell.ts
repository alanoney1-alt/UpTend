...
export const CROSS_SELL_MATRIX: Record<string, CrossSellSuggestion> = {
  junk_removal: {
    ...
    description: "Add a Home Cleaning deep clean and transform your space completely.",
    badge: "Perfect Combo",
  },
  home_cleaning: {
    ...
    description: "Schedule recurring Home Cleaning service and save on every visit.",
    badge: "Save 10%",
  },
  pressure_washing: {
    ...
    description: "Complete your exterior refresh with Gutter Cleaning gutter cleaning.",
    badge: "Bundle & Save",
  },
  gutter_cleaning: {
    ...
    description: "Add Pressure Washing pressure washing to make your home's exterior sparkle.",
  ...
  moving_labor: {
    ...
    description: "Add Home Cleaning move-out clean and leave your old home spotless.",
  },
  light_demolition: {
    serviceId: "light_demolition",
    suggestedService: "junk_removal",
    headline: "Debris from the demo? We'll haul it all.",
    description: "Add Junk Removal junk removal to clear out all the demolition debris.",
  },
  garage_cleanout: {
    serviceId: "garage_cleanout",
    suggestedService: "home_cleaning",
    headline: "Garage is done — want the house to match?",
    description: "Add Home Cleaning deep clean and get your whole home in order.",
  },
  truck_unloading: {
    serviceId: "truck_unloading",
    suggestedService: "home_cleaning",
    headline: "Just moved in? Start fresh with a deep clean.",
    description: "Add Home Cleaning deep clean before unpacking and settle into a spotless home.",
  },
  home_consultation: {
    serviceId: "home_consultation",
    suggestedService: "audit_recommendations",
    headline: "Book recommended services from your audit",
    description: "After your AI Home Audit, we'll recommend specific services based on what we find.",
  },
};
